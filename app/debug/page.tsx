...
export default async function DebugPage() {
  ...
  try {
    ...
    paypalHealth = {
      ...
      tokenReceived: false,
      error: message,
      likelyCause: message.includes("client credentials") ? "Sandbox/live credentials may not match the current PayPal environment." : undefined,
    }
  }
